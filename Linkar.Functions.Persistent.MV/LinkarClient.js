...
class LinkarClient {
	...
	/*
		...
		function MyRead()
		{
			try
			{
				...
				var result = client.Read("LK.CUSTOMERS","2");
			}
			catch (error)
			{
				console.log(error);
	...
	*/
	...
	/*
		...
		---
	*/
	UpdatePartial(filename, records, dictionaries, updateOptions = new LinkarFunctions.UpdateOptions(),
		customVars = "", receiveTimeout = 0) {
	...
	/*
		...
		function MySubroutine()
		{
			try
			{
				...
				var result = client.Subroutine("SUB.DEMOLINKAR", 3,		// 3 arguments
