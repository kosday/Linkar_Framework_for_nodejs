...
class LkPropertiesOptions
{
    ...
    //LK.SCHEMAS
	LkSchemas(rowHeader = RowHeaders.RowHeaders.MAINLABEL, rowProperties = false, onlyVisibles = false, usePropertyNames = false, pagination = false, regPage = 10, numPage = 1)
    {
        this.SchemaType = SchemaTypes.SchemaTypes.LKSCHEMAS;
        this.SqlMode = false;
